<template>
    <div style="position: relative;overflow-x: hidden;height:auto;">
        ...
        <div class="new-goods-box">
            <div v-if="showList == 1">
                <goodsLi class="goodsLi" v-for="(item,index) in goodsList" type="recommendGoods" :key="index" @showCart="shoppingInCart($event)" :item="item" :page="gpage" :lock="lock" :index="index"></goodsLi>
