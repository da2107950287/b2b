<template>
    <div >
                        ...
                        <a href="javascript:;" @click="toGoods(item.wId)">
                            <div class="purchare-itme">
                                ...
                                <div class="purchasePriceDiv">
                                    ...
                                    <div class="purchaseDelPrice" v-if="item.market_price != null">&yen;{{item.market_price}}<template v-if="item.goods_unit != null && item.goods_unit != ''">/{{item.goods_unit}}</template></div>
                                </div>
                            </div>
                        </a>
                    </swiper-slide>
        ...
        <store-list :is-index="true" :allCategory="allCategory" :marketSortLists="marketSortLists"></store-list>
...
// const business = () => import('./component/business/business.vue');
// 
const storeList = () => import('./indexBanner/storeList.vue')
