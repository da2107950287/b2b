    ...
    <div class="goods-oder-box">
      ...
      <div class="goods-order-one" v-show="show == 1">
        <div class="goods-order-one-title">
          <div class="goods-order-one-title-box" :data-id="goodsOrderTwo.id">
            <div>{{goodsOrderTwo.name}}</div>
          </div>
            ...
            <div v-for="(item,index) in goodsOrderTwo.values" :key="index">
              <van-row class="goods-order-ont-lis ">
                <van-col span="10" class="dflex-left">
                  <span class="goods-order-ont-lis-label" data-id="1" :id="item.id">
                    <div>{{item.label}} <span class="goods-order-ont-lis-unit">{{item.goods_desc}}</span></div>
                    <!-- <div>{{item.label}} <span class="goods-order-ont-lis-unit">({{item.format}}{{measure_unit}}/{{item.unit}})</span></div> -->
                    <img src="../../assets/img/chen.png" alt="" v-if="item.recosting==1">
                  </span>
                </van-col>
                <div class="dflex">
      ...
      <div class="goods-order-two" v-show="show == 2">
        ...
        <div v-for="(item,index) in goodsOrderOne.infoTwo" :key="index" class="current">
          ...
          <div class="goods-order-ont-lis-box" :class="{'mb_50': item.values.length < 5}" v-for="(val,index) in item.values" :key="index" :data-id="val.id">
            <van-row class="goods-order-ont-lis ">
              <van-col span="10" class="dflex-left">
                <span class="goods-order-ont-lis-label" data-id="1" :id="item.id">{{val.label}}</span>
                <span class="goods-order-ont-lis-unit" data-id="1" :id="item.id">{{item.goods_desc}}</span>
                <!-- <span class="goods-order-ont-lis-unit" data-id="1" :id="item.id">({{val.format}}{{measure_unit}}/{{val.unit}})</span> -->
              </van-col>
              <div class="dflex">
                <van-col span="6" class="dflex-center">
                  <div class="goods-order-price">
