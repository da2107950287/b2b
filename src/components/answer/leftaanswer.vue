<template>
    <div>
        <div v-if="show === 2">
            <div v-for="(item,index) in leftdata" :key="index" class="sales_list_li">
                <div class="sales_list_cont">
                    <div class="sales_list_order_no fz_14 color_424242 djust">
                        <span class="dflex " @click="toSeller(item.seller_id)">
                    ...
                    <div >
                        <div class="goods_box_all" @click="seeOrder(item.order_sn)">
                    ...
                    <div class="button_box fz_14" >
                        <div class="dflex">
                            <van-button class="read_order" @click.stop="seeOrder(item.order_sn)">查看订单</van-button>
                            <van-button @click.stop="writeleft(item.order_id,item.goods)" class="eval">评价</van-button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            _this.$post("/?c=order&a=list", {
                                ...
                                switch (res.code){
                                    ...
                                    if(res.data.list.length>0){
                                        _this.leftdata=[..._this.leftdata,...res.data.list];
                                    }
...
.sales_list_li .sales_list_cont .button_box div button.van-button.eval{
